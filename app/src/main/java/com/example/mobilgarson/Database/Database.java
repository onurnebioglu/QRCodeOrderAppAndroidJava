package com.example.mobilgarson.Database;
...
public class Database extends SQLiteAssetHelper{
    ...
    private static final String DB_NAME = "MobilGarsonAppDB.db";
    ...
    public String isEmpty()
    {
        ...
        String count = "SELECT count(*) FROM OrderDetail";
